...
async def handle_rpc_method(method, data, session_id, rpc_id, sessions):
    ...
    session = Session(
        ...
        client_capabilities=ClientCapabilities(raw_session.get("client_capabilities", {})),
    ...
    raw_session["client_capabilities"] = session.client_capabilities.get_capabilities()
